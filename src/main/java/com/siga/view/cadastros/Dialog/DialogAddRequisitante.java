 ...
 * @author Julio
 */
public class DialogAddRequisitante extends javax.swing.JFrame {

    /**
     * Creates new form Categoria
     */
    public DialogAddRequisitante() {
        initComponents();
    }
    ...
    public static void iniciar() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogAddRequisitante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DialogAddRequisitante().setVisible(true);
            }
        });
    }
